...
public class AudioSpectrum extends Game{
	...
	public void create () {		
		...
		// create the decoder (you can use a VorbisDecoder if you want to read ogg files)
	...
	public void render() {
		...
		for (int i = 0; i < NB_BARS; i++) {
			...
			batch.draw(colors, i*barWidth, 0, barWidth, avg(histoX, nb)/256*HEIGHT*2.0f, 0, 0, 16, 5, false, false);
			// drawing max values (in yellow)
			batch.draw(colors, i*barWidth, topValues[histoX]/256*HEIGHT*2.0f, barWidth, 4, 0, 5, 16, 5, false, false);
			// drawing top values (in red)
			batch.draw(colors, i*barWidth, maxValues[histoX]/256*HEIGHT*2.0f, barWidth, 2, 0, 10, 16, 5, false, false);
